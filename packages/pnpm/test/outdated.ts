...
test('pnpm outdated: only current lockfile is available', async (t: tape.Test) => {
  ...
  t.equal(normalizeNewline(result.stdout.toString()), stripIndent`
    ...
    Package     │ Current │ Latest     │ Details                                  ║
    ────────────┼─────────┼────────────┼──────────────────────────────────────────╢
    flatten     │ 1.0.2   │ Deprecated │ I wrote this module a very long time ago ║
                │         │            │ ; you should use something else.         ║
                │         │            │ https://github.com/jesusabdullah/node-fl ║
                │         │            │ atten#readme                             ║
    ────────────┼─────────┼────────────┼──────────────────────────────────────────╢
    is-negative │ 1.0.0   │ 2.1.0      │ https://github.com/kevva/is-negative#rea ║
                │         │            │ dme                                      ║
    ────────────┼─────────┼────────────┼──────────────────────────────────────────╢
    is-positive │ 1.0.0   │ 3.1.0      │ https://github.com/kevva/is-positive#rea ║
                │         │            │ dme                                      ║
    ════════════╧═════════╧════════════╧══════════════════════════════════════════╝
  ` + '\n')
})
...
test('pnpm outdated: only wanted lockfile is available', async (t: tape.Test) => {
  ...
  t.equal(normalizeNewline(result.stdout.toString()), stripIndent`
    ...
    Package     │ Current                │ Latest     │ Details                                  ║
    ────────────┼────────────────────────┼────────────┼──────────────────────────────────────────╢
    flatten     │ missing (wanted 1.0.2) │ Deprecated │ I wrote this module a very long time ago ║
                │                        │            │ ; you should use something else.         ║
                │                        │            │ https://github.com/jesusabdullah/node-fl ║
                │                        │            │ atten#readme                             ║
    ────────────┼────────────────────────┼────────────┼──────────────────────────────────────────╢
    is-positive │ missing (wanted 3.1.0) │ 3.1.0      │ https://github.com/kevva/is-positive#rea ║
                │                        │            │ dme                                      ║
    ────────────┼────────────────────────┼────────────┼──────────────────────────────────────────╢
    is-negative │ missing (wanted 1.1.0) │ 2.1.0      │ https://github.com/kevva/is-negative#rea ║
                │                        │            │ dme                                      ║
    ════════════╧════════════════════════╧════════════╧══════════════════════════════════════════╝
  ` + '\n')
})
...
test('pnpm outdated with external lockfile', async (t: tape.Test) => {
  ...
  t.equal(normalizeNewline(result.stdout.toString()), stripIndent`
    ...
    Package     │ Current              │ Latest │ Details                                  ║
    ────────────┼──────────────────────┼────────┼──────────────────────────────────────────╢
    is-positive │ 1.0.0 (wanted 3.1.0) │ 3.1.0  │ https://github.com/kevva/is-positive#rea ║
                │                      │        │ dme                                      ║
    ────────────┼──────────────────────┼────────┼──────────────────────────────────────────╢
    is-negative │ 1.0.0 (wanted 1.1.0) │ 2.1.0  │ https://github.com/kevva/is-negative#rea ║
                │                      │        │ dme                                      ║
    ════════════╧══════════════════════╧════════╧══════════════════════════════════════════╝
  ` + '\n')
})
